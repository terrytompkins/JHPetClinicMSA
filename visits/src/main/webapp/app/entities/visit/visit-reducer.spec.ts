...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './visit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VISIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_VISIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VISIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VISIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VISIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VISIT actions', async () => {
      const expectedActions = [
        {
