...
export const OwnerDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.visits.owner.updateSuccess);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="visitsApp.petOwner.delete.question">
        <Translate contentKey="visitsApp.petOwner.delete.question" interpolate={{ id: ownerEntity.id }}>
