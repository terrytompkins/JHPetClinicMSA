...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './owner.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OWNER_LIST actions', async () => {
    ...
    it('dispatches FETCH_OWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OWNER actions', async () => {
      const expectedActions = [
        {
