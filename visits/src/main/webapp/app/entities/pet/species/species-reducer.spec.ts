...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './species.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPECIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPECIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPECIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPECIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPECIES actions', async () => {
      const expectedActions = [
        {
