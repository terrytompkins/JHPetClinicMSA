...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PET_LIST actions', async () => {
    ...
    it('dispatches FETCH_PET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PET actions', async () => {
      const expectedActions = [
        {
