...
export const Specialty = () => {
  ...
  const specialtyList = useAppSelector(state => state.visits.specialty.entities);
  const loading = useAppSelector(state => state.visits.specialty.loading);
  const totalItems = useAppSelector(state => state.visits.specialty.totalItems);
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/specialty/${specialty.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/specialty/${specialty.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
