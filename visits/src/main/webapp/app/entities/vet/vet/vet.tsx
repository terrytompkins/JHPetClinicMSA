...
export const Vet = () => {
  ...
  const vetList = useAppSelector(state => state.visits.vet.entities);
  const loading = useAppSelector(state => state.visits.vet.loading);
  const totalItems = useAppSelector(state => state.visits.vet.totalItems);
  ...
  return (
    <div>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/vet/${vet.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/vet/${vet.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
      ...
      {totalItems ? (
        <div className={vetList && vetList.length > 0 ? '' : 'd-none'}>
