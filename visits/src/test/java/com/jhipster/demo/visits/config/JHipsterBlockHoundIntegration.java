package com.jhipster.demo.visits.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jhipster.demo.visits.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.jhipster.demo.visits.security.DomainUserDetailsService", "createSpringSecurityUser");
