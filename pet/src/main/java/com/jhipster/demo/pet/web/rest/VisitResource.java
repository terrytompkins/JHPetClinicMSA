...
/**
 * REST controller for managing {@link com.jhipster.demo.pet.domain.Visit}.
 */
@RestController
@RequestMapping("/api")
public class VisitResource {
    ...
    private static final String ENTITY_NAME = "petVisit";
    ...
    public ResponseEntity<VisitDTO> updateVisit(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, visitDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<VisitDTO> partialUpdateVisit(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, visitDTO.getId())
        );
    }
